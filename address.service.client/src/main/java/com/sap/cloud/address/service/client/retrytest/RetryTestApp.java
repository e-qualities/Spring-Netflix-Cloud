...
public class RetryTestApp {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RetryTestApp.class);
    ...
    public static void main(String[] args) throws RestClientException, IOException {
        ...
        logger.info("{}", failingAddressServiceClient);
        logger.info("Address from RestTemplate Approach: " + failingAddressServiceClient.getAddress());
    }
