package com.sap.cloud.address.service.client.cf;
...
public class CFLoadBalancerRequestTransformer implements LoadBalancerRequestTransformer {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CFLoadBalancerRequestTransformer.class);
    ...
    public HttpRequest transformRequest(HttpRequest request, ServiceInstance instance) {
        ...
        logger.info("Transforming Request from LoadBalancer Ribbon).");
        ...
        if (metadata.containsKey(CF_APP_GUID) && metadata.containsKey(CF_INSTANCE_INDEX)) {
            ...
            logger.info("Returning Request with Special Routing Header");
    ...
    private void dumpServiceInstanceInformation(Map<String, String> metadata, InstanceInfo instanceInfo) {
        ...
        try {
            ...
            logger.error("Caught exception while dumping service instance information", e);
        }
    }
